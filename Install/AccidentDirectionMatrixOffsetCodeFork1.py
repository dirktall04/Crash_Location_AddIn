...
databaseConnectionsFolder = r'C:\Users\dtalley\AppData\Roaming\ESRI\Desktop10.3\ArcCatalog'
aliasFieldsToJoin = ['KDOT_ROUTENAME', 'A_RD', 'LABEL']
roadsRelClass = r'C:\GIS\Geodatabases\crashDataTesting.gdb\Roads_KDOT_RelClass'
...
def InitalizeCurrentPathSettings():
    ...
    pathSettingsInstance.roadsFeaturesLocation = r'C:\GIS\Geodatabases\crashDataTesting.gdb\RoadCenterlines'
    pathSettingsInstance.aliasTable = r'C:\GIS\Geodatabases\crashDataTesting.gdb\RoadAlias_KDOT'
    pathSettingsInstance.accidentDataAtIntersections = r'C:\GIS\Geodatabases\crashDataTesting.gdb\Wichita_Crash_Points'
    pathSettingsInstance.accidentDataWithOffsetOutput = r'C:\GIS\Geodatabases\crashDataTesting.gdb\Wichita_Crash_Points_Offset'
